...
public class HeaderPageUI {
	public static final String REGISTER_LABEL = "//a[@class='ico-register']";
	public static final String LOGIN_LABEL = "//a[@class='ico-login']";
	public static final String LOGOUT_LABEL = "//a[@class='ico-logout']";
	public static final String WISHLIST_LABEL = "//a[@class='ico-wishlist']";
