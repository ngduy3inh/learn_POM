...
public class ShoppingCartUI {
	...
	public static final String QUANTITY_OF_PRODUCT_TEXTBOX 
	= "//a[text()='%s']/parent::td[@class='product']//following-sibling::td[@class='quantity']//input[@class='qty-input']";
	//
	...
	public static final String REMOVE_PRODUCT_IN_SHOPPING_CART_BUTTON 
	= "//a[text()='%s']/parent::td[@class='product']//following-sibling::td[@class='remove-from-cart']//button[@class='remove-btn']";
